...
- `lesson_1_task_1.py` — переменная `my_name = "Анна"` и её вывод.
- `lesson_1_task_2.py` — переменная `my_age = 25`, затем возраст через 3 года, вывод.
...
- `lesson_1_task_5.py` — параметризованная функция; 11 вызовов печатают номер телефона.
